...
url: 'https://api.apixu.com/vl/forecast.json?key=a246c57c92b9419da62174959162404',
...
*/
        ...
        $(document).ready(function(){
           $(':button').click(function(){
                ...
                $.ajax({
                      type: 'GET',
                      url: 'https://api.apixu.com/v1/forecast.json?key=a246c57c92b9419da62174959162404',
                      data: message             
                })
                .done(function(json){
